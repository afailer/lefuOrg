...
public class ElderlyFragmentAdapter extends FragmentPagerAdapter {

    private Context mContext;
    private PagerSlidingTabStrip mPagerStrip;
    private List<ViewPageInfo> mTabs = new ArrayList<ViewPageInfo>();

    public ElderlyFragmentAdapter(FragmentManager fm,
    ...
    private void addFragment(ViewPageInfo info) {
        ...
        View v = LayoutInflater.from(mContext).inflate(
                R.layout.item_fragment_elderly_viewpage_tab, mPagerStrip, false);
        TextView title = (TextView) v.findViewById(R.id.tv_item_fragment_elderly_viewpager_tab);
