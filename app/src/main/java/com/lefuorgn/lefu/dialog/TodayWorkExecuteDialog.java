...
public class TodayWorkExecuteDialog extends DialogFragment implements View.OnClickListener{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_today_work_execute, null);
        ...
        view.findViewById(R.id.tv_dialog_nursing_info_camera).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_dialog_nursing_info_pic:
                ...
                break;
            case R.id.tv_dialog_nursing_info_camera:
                if(mMultiMedias.size() >= 9) {
                    ToastUtils.show(getContext(), "最多添加9项");
                    return;
                }
                // 获取视频
                intent = new Intent(getActivity(), MultiMediaActivity.class);
                intent.putExtra(MultiMediaActivity.MULTIMEDIA_TYPE, MultiMediaActivity.ACTION_IMAGE_CAPTURE);
                startActivityForResult(intent, 100);
                break;
     ...
     * @return 当前对象
     */
    public TodayWorkExecuteDialog setTitle(String title) {
        mTitle = title;
        return this;
    }
     ...
     * @return 当前对象
     */
    public TodayWorkExecuteDialog setClickCallBack(ClickCallBack callBack) {
