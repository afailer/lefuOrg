...
public class NumberViewBuilder extends LabelViewBuilder {

    private EditText mValueView;

    public NumberViewBuilder(Context context, int paddingWidth, int paddingHeight,
