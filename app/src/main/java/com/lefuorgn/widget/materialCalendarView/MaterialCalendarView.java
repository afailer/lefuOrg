...
import com.lefuorgn.widget.materialCalendarView.format.ArrayWeekDayFormatter;
import com.lefuorgn.widget.materialCalendarView.format.DateFormatTitleFormatter;
import com.lefuorgn.widget.materialCalendarView.format.DayFormatter;
import com.lefuorgn.widget.materialCalendarView.format.MonthArrayTitleFormatter;
import com.lefuorgn.widget.materialCalendarView.format.TitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public void addDecorator(DayViewDecorator decorator) {
        ...
        if(!dayViewDecorators.contains(decorator)){
    ...
    public void setDecorator(DayViewDecorator decorator) {
        if (decorator == null) {
            return;
        }
