...
import com.lefuorgn.widget.materialCalendarView.format.WeekDayFormatter;
...
import static com.lefuorgn.widget.materialCalendarView.MaterialCalendarView.SHOW_DEFAULTS;
import static com.lefuorgn.widget.materialCalendarView.MaterialCalendarView.showOtherMonths;
...
abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener {
    ...
    void setDayViewDecorator(DecoratorResult result) {
        this.decoratorResult=result;
        invalidateDecorator();
    }
    ...
    protected void invalidateDecorator(){
        final DayViewFacade facadeAccumulator = new DayViewFacade();
        for(DayView dayView:dayViews){
            facadeAccumulator.reset();
            if(decoratorResult.decorator.shouldDecorate(dayView.getDate())){
                decoratorResult.result.applyTo(facadeAccumulator);
            }
            dayView.applyFacade(facadeAccumulator);
        }
    }
