...
abstract class AndroidSpringLooperFactory {
  ...
  /**
   * Create an Android {@link com.lefuorgn.widget.togglebutton.SpringLooper} for the detected Android platform.
   * @return a SpringLooper
   */
  static SpringLooper createSpringLooper() {
  ...
  private static class LegacyAndroidSpringLooper extends SpringLooper {
    ...
    LegacyAndroidSpringLooper(Handler handler) {
      mHandler = handler;
  ...
  private static class ChoreographerAndroidSpringLooper extends SpringLooper {
    ...
    ChoreographerAndroidSpringLooper(Choreographer choreographer) {
