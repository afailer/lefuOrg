...
public class ToggleButton extends View{
	...
	/**
	 * 设置toggle的状态
	 * @param animate true: 打开; false:关闭
	 */
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if(widthMode == MeasureSpec.UNSPECIFIED || widthMode == MeasureSpec.AT_MOST){
			int widthSize = (int) TypedValue
                    .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, r.getDisplayMetrics());
			widthMeasureSpec = MeasureSpec.makeMeasureSpec(widthSize, MeasureSpec.EXACTLY);
		}
		
		if(heightMode == MeasureSpec.UNSPECIFIED || heightMode == MeasureSpec.AT_MOST){
			int heightSize = (int) TypedValue
                    .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 30, r.getDisplayMetrics());
	...
	protected void onLayout(boolean changed, int left, int top, int right,
        ...
        offLineWidth = (float) SpringUtil.mapValueFromRangeToRange(1, 0, 1, 10, spotSize);
